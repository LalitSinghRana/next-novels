...
export default function RootLayout({
	...
	return (
		<AlertDialog defaultOpen>
			<AlertDialogContent>
				<AlertDialogHeader>
					<AlertDialogTitle>Currently desktop browsers are not supported</AlertDialogTitle>
					<AlertDialogDescription>Visit this page on a mobile device to read this story.</AlertDialogDescription>
				</AlertDialogHeader>
				<AlertDialogFooter>
